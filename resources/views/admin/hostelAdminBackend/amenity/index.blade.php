...
@section('content')
    <div class="main-content">
        <div class="breadcrumb">
            ...
            <ul>
                <li><a href="{{ route('hostelAdmin.hostel-amenity.index') }}" class="text-primary">Index</a></li>
                <li>Hostel Amenity</li>
            </ul>
        </div>
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-end mb-3">
                            <div class="clearfix mr-3">
                                <a href="{{ route('hostelAdmin.hostel-amenity.create') }}" class="btn btn-success">
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    <a class="btn btn-warning mr-1"
                                                        href="{{ route('hostelAdmin.hostel-amenity.edit', $amenity->slug) }}">
...
@section('script')
    <script>
        $(document).ready(function() {
            deleteAction('.delete-amenity', 'hostel/hostel-amenity');
            updatePublishStatus('.published', 'hostel-amenity/publish');
        });
    </script>
@endsection
