...
@section('content')
    <div class="main-content">
        <div class="breadcrumb">
            ...
            <ul>
                <li>
                    <a href="{{ route('hostelAdmin.inventory.index') }}" class="text-primary">Index</a>
                </li>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card mb-4 bg-white">
                    <div class="card-body">
                        <form
                            action="{{ $inventory ? route('hostelAdmin.inventory.update', $inventory->slug) : route('hostelAdmin.inventory.store') }}"
                            ...
                            <div class="row">
                                @php
                                    ...
                                    $isWarden = $hostelUser && $hostelUser->pivot->role_id == 3;

                                    $wardenBlock = null;
                                    if ($isWarden) {
                                        $wardenBlock = \App\Models\Block::where('hostel_id', $hostelUser->id)
                                            ->where('warden_id', Auth::id())
                                            ->first();
                                    }
                                @endphp

                                @if ($isWarden && $wardenBlock)
                                    <input type="hidden" name="block_id" value="{{ $wardenBlock->id }}">
                                    <div class="col-md-4 form-group">
                                        <label>
                                            <h6>Hostel Block <code>*</code></h6>
                                        </label>
                                        <input type="text" class="form-control" value="{{ $wardenBlock->name }}"
                                            disabled>
                                    </div>
                                @else
                                    <div class="col-md-4 form-group">
                                ...
                                <div class="col-md-4 form-group">
                                    <label for="type">
                                        <h6>Transaction Type <code>*</code></h6>
                                    </label>
                                        ...
                                        @foreach (old('item') as $key => $item)
                                            <div class="inventory-item">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3 form-group mb-3">
                                                        <label for="total">
                                                            <h6>Total<code>*</code> <code>*</code></h6>
                                                        </label>
                                                        <input
                ...
                let invItem = `
                    <div class="inventory-item" data-index="${newIndex}">
                        <div class="row">
                            ...
                            <div class="col-md-3 form-group mb-3">
                                <label><h6>Total <code>*</code></h6></label>
