...
<section class="bg-[#0d1b2d] w-full h-[70px] flex items-center sticky top-[88px] z-10">
    <div
        ...
        <!-- Left Section -->
        <h1 class="text-2xl sm:text-xl font-bold text-color mb-2 sm:mb-0 font-heading text-white">
            {{ $hostelDetail->name }}
        </h1>
        ...
        <nav class="text-sm font-medium text-color font-heading flex items-center space-x-0.5">
            ...
            <span class="text-white font-heading font-regular">Hostel Details</span>
        </nav>
    </div>
</section>
    ...
    <div class="flex flex-col lg:flex-row gap-8">
        ...
        <div class="lg:w-2/3">
            ...
            <div class="rounded-lg border border-[#E1DFDF] p-6 mb-6 mt-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-2">
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <span class="text-body text-sm font-heading font-regular">{{ $feature->feature_name }}</span>
                    </div>
                    @empty
            ...
            <div class="rounded-lg border border-color p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-2">
                    ...
                    <div class="flex items-center gap-3 bg-[#f1f4f4] rounded-lg p-4">
                        ...
                        @else
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-[#087878]" viewBox="0 0 24 24">
                            <path fill="currentColor"
                                d="M4 12a8 8 0 1 1 16 0a8 8 0 0 1-16 0m8-10C6.477 2 2 6.477 2 12s4.477 10 10 10s10-4.477 10-10S17.523 2 12 2m5.457 7.457l-1.414-1.414L11 13.086l-2.793-2.793l-1.414 1.414L11 15.914z" />
                        </svg>
                        @endif
                        <span class="text-sm text-body font-heading font-regular">{{ $amenity->amenity_name }}</span>
                    </div>
                    @empty
                    <div class="col-span-3">
            ...
            <div class="rounded-lg border border-color p-6 mt-6">
                ...
                <iframe src="{{ $hostelConfigs['google_map_embed'] }}" width="100%" height="450" style="border:0;"
                    ...
                    <div class="mb-4">
                        ...
                        <div class="flex items-center gap-1" role="radiogroup" aria-label="Rating">
                            ...
                            <button type="button"
                                ...
                                data-value="1" aria-label="1 star" role="radio" aria-checked="false" tabindex="0">
                                <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24"
                            ...
                            <button type="button"
                                class="feedback-star text-gray-300 hover:text-yellow-400 transition-colors transform hover:scale-105"
                                data-value="2" aria-label="2 stars" role="radio" aria-checked="false" tabindex="0">
                                <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24"
                                    fill="currentColor" class="w-5 h-5">
                                    <path
                                        d="M12 17.27L18.18 21l-1.64-7.03L22 9.24l-7.19-.61L12 2 9.19 8.63 2 9.24l5.46 4.73L5.82 21z" />
                            ...
                            <button type="button"
                                class="feedback-star text-gray-300 hover:text-yellow-400 transition-colors transform hover:scale-105"
                                data-value="3" aria-label="3 stars" role="radio" aria-checked="false" tabindex="0">
                                <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24"
                                    fill="currentColor" class="w-5 h-5">
                                    <path
                                        d="M12 17.27L18.18 21l-1.64-7.03L22 9.24l-7.19-.61L12 2 9.19 8.63 2 9.24l5.46 4.73L5.82 21z" />
                            ...
                            <button type="button"
                                class="feedback-star text-gray-300 hover:text-yellow-400 transition-colors transform hover:scale-105"
                                data-value="4" aria-label="4 stars" role="radio" aria-checked="false" tabindex="0">
                                <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24"
                                    fill="currentColor" class="w-5 h-5">
                                    <path
                                        d="M12 17.27L18.18 21l-1.64-7.03L22 9.24l-7.19-.61L12 2 9.19 8.63 2 9.24l5.46 4.73L5.82 21z" />
                            ...
                            <button type="button"
                                class="feedback-star text-gray-300 hover:text-yellow-400 transition-colors transform hover:scale-105"
                                data-value="5" aria-label="5 stars" role="radio" aria-checked="false" tabindex="0">
                                <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24"
                                    fill="currentColor" class="w-5 h-5">
                                    <path
                                        d="M12 17.27L18.18 21l-1.64-7.03L22 9.24l-7.19-.61L12 2 9.19 8.63 2 9.24l5.46 4.73L5.82 21z" />
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <div class="flex gap-2">
                                ...
                                <a href="{{ $hostelConfigs['social_facebook'] }}"
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" class="text-white" width="20" height="20"
                                        viewBox="0 0 24 24">
                                        <path fill="currentColor"
