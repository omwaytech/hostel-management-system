...
@section('body')
    ...
    <section class="bg-[#e0e2e5] w-full h-[70px] flex items-center sticky top-[88px] z-10">
        <div
            ...
            <nav class="text-base font-medium text-color font-heading flex items-center space-x-0.5">
                ...
                <span class="text-[#535b6a]">About</span>
            </nav>
        </div>
    </section>
    <!-- About Banner end -->
    @if (isset($about))
        ...
        <section class="bg-[#EAF2FB]/30 py-16 px-4 sm:px-6 lg:px-8 mt-[70px]">
            <div class="max-w-7xl mx-auto">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8 mt-5">
                    ...
                    <div class="relative pt-8">
                        <div class="absolute top-0 ml-8 left-1/2 transform -translate-x-1/2">
                            <div
        ...
        <section class="bg-[#EAF2FB]/20 py-16 px-4 sm:px-6 lg:px-20 mt-[70px]">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
                    ...
                    <div class="flex flex-col justify-center">
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="bg-white rounded-lg border border-color box-shadow p-6 flex items-center gap-3">
                                <div class="bg-[#4490D9] rounded-sm w-10 h-10 flex items-center justify-center shrink-0">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="text-white" width="24"
                            ...
                            <span
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    ...
                                    <path fill="none" stroke="currentColor" stroke-linecap="round"
                                        stroke-linejoin="round" stroke-width="1.5" d="M6 12h6m6 0h-6m0 0V6m0 6v6" />
                                </svg>
                            </span>
                        </button>
