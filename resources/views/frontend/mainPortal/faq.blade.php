...
<section class="bg-[#0d1b2d] w-full h-[70px] flex items-center sticky top-[88px] z-10">
    <div
        ...
        <!-- Left Section -->
        <h1 class="text-2xl sm:text-[20px] font-bold text-color mb-2 sm:mb-0 font-heading text-white">Frequently Asked
            Questions
        </h1>
        ...
        <nav class="text-sm font-medium text-color font-heading flex items-center space-x-0.5">
            ...
            <span class="text-white font-heading font-regular">FAQ's</span>
        </nav>
    </div>
</section>
<!-- FAQ's Banner end -->
