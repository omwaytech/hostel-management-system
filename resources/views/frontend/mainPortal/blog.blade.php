...
<section class="bg-[#0d1b2d] w-full h-[70px] flex items-center sticky top-[88px] z-10">
    <div
        ...
        <!-- Left Section -->
        <h1 class="text-2xl sm:text-[20px] font-bold text-color mb-2 text-white sm:mb-0 font-heading">News & Blogs
        </h1>
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6 max-w-8xl">
            ...
            <div class="bg-white rounded-[20px] box-shadow overflow-hidden">
                ...
                <div class="p-6">
                    ...
                    <p class="text-sm font-heading text-body font-light mt-2.5">{!! Str::words($blog->blog_description,
                        10) !!}</p>
