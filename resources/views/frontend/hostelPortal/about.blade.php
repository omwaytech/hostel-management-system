...
@section('body')
    ...
    <section class="bg-[#E5E4E2] w-full h-[80px] flex items-center sticky top-[88px] z-9999">
        <div
            ...
            <!-- Left Section -->
            <h1 class="text-2xl sm:text-[24px] font-bold text-color mb-2 sm:mb-0 font-heading">About us</h1>
    ...
    <section class="mt-10">
        <div class="max-w-[1920px] mx-auto px-4 sm:px-8 lg:px-[120px]">
            <div class="bg-white p-9 rounded-[8px] shadow-custom-combo">
                <div class="flex flex-col md:flex-row relative items-center">
                    ...
                    <div class="flex-1 px-6 py-6 md:py-0 max-md:border-b border-gray-300/80 font-heading">
                        ...
                        <p class="text-body leading-relaxed font-regular">
                    ...
                    <div class="flex-1 px-6 py-6 md:py-0 max-md:border-b border-gray-300/80 font-heading">
                        <div class="flex items-center gap-2 mb-1">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 512 512">
                                <circle cx="256" cy="160" r="128" fill="none" stroke="#4b5563"
                                ...
                                <circle cx="256" cy="160" r="64" fill="none" stroke="#4b5563"
                                    stroke-linecap="round" stroke-linejoin="round" stroke-width="32" />
                            </svg>
    ...
    <div class="max-w-[1920px] mx-auto mt-10">
        ...
        window.addEventListener('resize', () => checkSlide());" class="relative">
            ...
            <!-- Previous Button -->
            <button @click="prev()" :class="currentSlide === 0 ? 'opacity-50' : 'hover:bg-[#076166]'"
            ...
            <!-- Next Button -->
            <button @click="next()" :class="currentSlide === maxSlide ? 'opacity-50' : 'hover:bg-[#076166]'"
    ...
    <div id="modalOverlay"
        ...
        <div class="bg-white rounded-[8px] max-w-2xl w-full max-h-[90vh] overflow-y-auto relative">
            ...
            <div class="p-6 md:p-6">
                ...
                <form action="{{ route('hostel.inquiryStore', $hostel->slug) }}" method="POST"
