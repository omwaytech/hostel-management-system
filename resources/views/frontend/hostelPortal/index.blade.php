...
<div x-data="{
        ...
        clearFilters() {
            this.daysOfStay = 1;
            this.roomType = 'Select Room Type';
            this.priceRange = '';
            this.priceLabel = 'Select Price Range';
        ...
        nextRoom() {
            ...
            const carousel = this.$refs.roomCarousel;
            const cardsPerView = this.getRoomsPerView();
            const maxIndex = Math.max(0, this.searchResults.length - cardsPerView);
            
            if (this.roomCarouselIndex < maxIndex) {
                this.roomCarouselIndex++;
            } else {
                this.roomCarouselIndex = 0; // Loop back to start
            }
            
            const cardWidth = carousel.children[0] ? carousel.children[0].offsetWidth + 24 : 0; // 24px for gap
            carousel.scrollTo({
                left: this.roomCarouselIndex * cardWidth,
                behavior: 'smooth'
            });
        },
        prevRoom() {
            ...
            if (this.roomCarouselIndex > 0) {
                this.roomCarouselIndex--;
            } else {
                this.roomCarouselIndex = maxIndex; // Loop to end
            }
                    ...
                    <div class="flex flex-col md:flex-row gap-4 items-end w-full">
                            ...
                            <div
                                ...
                                <div class="text-left flex-1">
                                    <label for="days_of_stay" class="block text-xs text-gray-500 font-heading">Number of
                                        Days</label>
                                    <input type="number" id="days_of_stay" x-model="daysOfStay"
                                        @input.debounce.500ms="searchRooms()" min="1" placeholder="Enter days"
                                        class="block text-sm font-regular font-heading text-color bg-transparent border-0 focus:ring-0 p-0 w-full">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="relative w-full md:w-auto flex-1" x-data="{ roomTypeOpen: false }">
                            ...
                            <div x-show="roomTypeOpen" @click.away="roomTypeOpen = false"
                                ...
                                <div class="py-1">
                                    <a href="#" @click.prevent="roomType = 'Select Room Type'; roomTypeOpen = false"
                                        class="block px-4 py-2 text-sm !font-regular hover:bg-gray-100 font-heading text-gray-400">Select
                                        Room Type</a>
                                    <a href="#"
                                        @click.prevent="roomType = 'Private'; roomTypeOpen = false; searchRooms()"
                                        class="block px-4 py-2 text-sm hover:bg-gray-100 font-heading text-color">Private
                                        (Single)</a>
                                    <a href="#"
                                        @click.prevent="roomType = 'Shared'; roomTypeOpen = false; searchRooms()"
                        ...
                        <div class="relative w-full md:w-auto flex-1" x-data="{ priceRangeOpen: false }">
                            ...
                            <div x-show="priceRangeOpen" @click.away="priceRangeOpen = false"
                                ...
                                <div class="py-1">
                                    <a href="#"
                                        @click.prevent="priceRange = ''; priceLabel = 'Select Price Range'; priceRangeOpen = false"
                                        class="block px-4 py-2 text-sm hover:bg-gray-100 font-heading text-gray-400">Select
                                        Price Range</a>
                                    <a href="#"
                                        @click.prevent="priceRange = '5000-15000'; priceLabel = 'NPR 5,000 - 15,000'; priceRangeOpen = false; searchRooms()"
                                        class="block px-4 py-2 text-sm hover:bg-gray-100 font-heading text-color">NPR
                                        5,000 - 15,000</a>
                                    <a href="#"
                                        @click.prevent="priceRange = '15000-25000'; priceLabel = 'NPR 15,000 - 25,000'; priceRangeOpen = false; searchRooms()"
                                        class="block px-4 py-2 text-sm hover:bg-gray-100 font-heading text-color">NPR
                                        15,000 - 25,000</a>
                                    <a href="#"
                                        @click.prevent="priceRange = '25000-35000'; priceLabel = 'NPR 25,000 - 35,000'; priceRangeOpen = false; searchRooms()"
                                        class="block px-4 py-2 text-sm hover:bg-gray-100 font-heading text-color">NPR
                                        25,000 - 35,000</a>
                                    <a href="#"
                                        @click.prevent="priceRange = '35000-50000'; priceLabel = 'NPR 35,000 - 50,000'; priceRangeOpen = false; searchRooms()"
                                        class="block px-4 py-2 text-sm hover:bg-gray-100 font-heading text-color">NPR
                                        35,000 - 50,000</a>
                                </div>
                            </div>
    ...
    <div x-show="showResults" x-cloak class="w-full mt-10" id="searchResultsSection">
        <div class="max-w-[1920px] mx-auto px-4 md:px-8 lg:px-[120px]">
                ...
                <div class="flex items-center gap-6">
                    <div class="flex items-center gap-4">
                        <div class="flex items-center gap-2">
                            ...
                            <span class="text-sm text-color tracking-tight font-medium font-heading">Available
                                Rooms</span>
                        </div>
                        <div class="flex items-center gap-2">
                    ...
                    <div x-show="searchResults && searchResults.length > getRoomsPerView()" class="flex gap-2">
            ...
            <!-- Rooms Carousel -->
            <div x-show="searchResults && searchResults.length > 0" class="relative overflow-hidden">
                <div x-ref="roomCarousel" class="flex transition-transform duration-500 ease-in-out gap-6">
                    <template x-for="room in searchResults" :key="room.id">
                        <div
                            class="flex-none w-full md:w-[calc(50%-12px)] lg:w-[calc(33.333%-16px)] 2xl:w-[calc(25%-18px)]">
                            <div
                                class="bg-white rounded-lg border border-[#E1DFDF] overflow-hidden hover:shadow-lg transition-shadow duration-300 h-full">
                                <!-- Room Image -->
                                ...
                                <div class="p-5">
                                    ...
                                    <div class="flex items-center justify-between mb-3">
                                        ...
                                        <span class="text-sm text-gray-600 font-heading"
                                            x-text="room.block_name"></span>
                                    </div>
                                    ...
                                    <div class="flex justify-end">
                                        <button type="button" @click="openBookingModal(room)"
                                            class="block w-28 text-center bg-[#00A1A5] hover:bg-[#076166] text-white font-heading font-bold py-2 px-4 rounded-lg transition-colors duration-200">
                                            Book Now
                                        </button>
                                    </div>
                                </div>
            ...
            <div class="relative bg-white rounded-lg shadow-xl max-w-2xl w-full mx-auto"
                ...
                <div class="p-6">
                    <form @submit.prevent="submitBooking()" class="space-y-4">
                        ...
                        <!-- Name -->
                        <div>
                            <label for="booking_name" class="block text-sm font-medium text-gray-700 mb-1 font-heading">
                        ...
                        <div x-data="{ tooltip: false }" @mouseleave="tooltip = false" class="relative">
                            <div @mouseenter="tooltip = true"
                                ...
                                <div class="flex items-center justify-between mb-5">
                                    ...
                                    <div class="flex items-center gap-2">
                                        <svg class="text-sub-text" xmlns="http://www.w3.org/2000/svg" width="20"
                            ...
                            <div x-show="tooltip" x-transition:enter="transition ease-out duration-200"
                                ...
                                <div class="space-y-2">
                                    ...
                                    <div class="flex justify-between">
                                        <span class="text-sm sub-text font-heading font-regular tracking-tight">Room
                                            Type:</span>
                                        <span class="text-sm font-medium text-color font-heading tracking-tight">
                                            {{ $room->occupancy ? $room->occupancy->occupancy_type : 'N/A' }}
                                        </span>
                                    </div>
        ...
        <div class="flex flex-col lg:flex-row gap-3 items-start justify-between">
            ...
            <div class="w-full lg:flex-1">
                <div class="w-full h-[440px] rounded-[8px] overflow-hidden ">
                    ...
                    <iframe src="{{ $hostelConfigs['google_map_embed'] }}" width="100%" height="100%" style="border:0;"
