        ...
        <div class="lg:w-2/3">
            ...
            <div class="relative mb-8 rounded-lg overflow-hidden group">
                ...
                <div class="swiper mainSwiper group">
                    ...
                    <!-- Navigation Buttons -->
                    @php
                    // Count actual images - currently only 1 main photo per room
                    $imageCount = $room->photo ? 1 : 0;
                    @endphp
                    <div
                        class="swiper-button-prev !w-9 !h-9 md:!w-9 md:!h-9 bg-white rounded-full shadow-custom-combo border border-[#E1DFDF] !left-4 md:!left-6 after:!content-none {{ $imageCount < 2 ? 'hidden' : 'flex' }} items-center justify-center">
                    ...
                    <div
                        class="swiper-button-next !w-9 !h-9 md:!w-9 md:!h-9 bg-white rounded-full shadow-custom-combo border-[#E1DFDF] !right-4 md:!right-6 after:!content-none {{ $imageCount < 2 ? 'hidden' : 'flex' }} items-center justify-center">
                        <svg xmlns="http://www.w3.org/2000/svg" class="text-color width=" 16" height="16"
                            viewBox="0 0 24 24">
                            <path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
            ...
            <div class="sticky top-[180px]">
                <div class="bg-white rounded-[8px] border border-[#E1DFDF] p-6 mb-6">
                    ...
                    <div class="flex justify-center">
                        <button disabled
                            class="block w-60 bg-gray-400 cursor-not-allowed font-heading text-base text-white font-bold py-3 px-6 rounded-full mb-2 text-center opacity-60"
